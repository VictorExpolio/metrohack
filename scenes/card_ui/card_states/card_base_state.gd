...
func enter() -> void:
	...
	#si ejecutas muy rápido la acción de pasar de BASE->DRAG->AIM puede buggearse
	#y volver al DRAG, con esto terminamos la animación para que no se rompa la transición
